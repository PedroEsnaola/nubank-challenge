...
class SellFinanceOperationProcessorTest {
    ...
    void givenHighProfit_whenSellingShares_shouldCalculateTaxCorrectly() {
        var context = FinanceOperationContextStubs.withAverageCostLossAndShares(BigDecimal.valueOf(100), BigDecimal.ZERO, 200l);
        var result = (TaxFinanceOperationResult) underTest.process(selling(BigDecimal.valueOf(150), 200), context);
        ...
        assertThat(context.getTotalShares()).isEqualTo(0l);
    }
    ...
    void givenNoProfit_whenSellingShares_shouldCalculateZeroTax() {
        var context = FinanceOperationContextStubs.withAverageCostLossAndShares(BigDecimal.valueOf(100), BigDecimal.ZERO,50l );
        var result = (TaxFinanceOperationResult) underTest.process(selling(BigDecimal.valueOf(100), 50), context);
    ...
    void givenPreviousLoss_whenSellingAtProfit_shouldDeductLossBeforeCalculatingTaxAndDontPayTaxesDueToLowProfit() {
        var context = FinanceOperationContextStubs.withAverageCostLossAndShares(BigDecimal.valueOf(100), BigDecimal.valueOf(2000), 100l);
        var result = (TaxFinanceOperationResult) underTest.process(selling(BigDecimal.valueOf(150), 100), context);
    ...
    void givenALoss_whenSellingShares_shouldUpdateLossInContext() {
        var context = FinanceOperationContextStubs.withAverageCostLossAndShares(BigDecimal.valueOf(100), BigDecimal.valueOf(500), 100l);
        var result = (TaxFinanceOperationResult) underTest.process(selling(BigDecimal.valueOf(70), 100), context);
    ...
    void givenHighSaleValueNoProfit_whenSellingShares_shouldCalculateZeroTax() {
        var context = FinanceOperationContextStubs.withAverageCostLossAndShares(BigDecimal.valueOf(200), BigDecimal.ZERO, 200l);
        var result = (TaxFinanceOperationResult) underTest.process(selling(BigDecimal.valueOf(200), 200), context);
